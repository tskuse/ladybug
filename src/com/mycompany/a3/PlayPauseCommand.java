...
public class PlayPauseCommand extends Command {
    ...
    private Game game;
    private Vector<Component> playControlComponents;

    private PlayPauseCommand(GameWorld gw, Game game, Vector<Component> playControlComponents) {
        super("Pause");
        this.gw = gw;
        this.game = game;
        this.playControlComponents = playControlComponents;
    }

    public static PlayPauseCommand getCommand(GameWorld gw, Game game, Vector<Component> playControlComponents) {
        if (command == null) {
            command = new PlayPauseCommand(gw, game, playControlComponents);
        }
        return command;
    }
    ...
    public void actionPerformed(ActionEvent evt) {
        if (getCommandName().equals("Pause")) {
            ...
            for (Component cmp : playControlComponents) {
